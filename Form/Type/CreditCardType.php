 ...
 * 
 * @filesource /src/Mesd/FormTypeBundle/Form/Type/CreditCardType.php
...
class CreditCardType extends AbstractType
{
     ...
     *
     * @since  0.2.0
     * @return string The string 'mesd_form_type_creditcard'
     */
    public function getName()
    {
        return 'mesd_form_type_creditcard';
    }
